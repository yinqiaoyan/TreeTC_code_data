...
priorDriftMin = 1
priorDriftMax = mean(diag(empCov)) / 5
...
q0 <- Normal$new(priorSigmaScale = priorSigmaScale,
                 priorSigmaShape = priorSigmaShape,
                 priorSigmaMin = NULL,
                 priorSigmaMax = NULL,
...
save(q0, tssb, ll_UnPost, clIds, numOfTrees, groups_subj, ggFinal1, ggFinal2, 
     subFinalClIds1, subFinalClIds2, subFinalCenters1, subFinalCenters2, 
     finalSigma, finalDrift, tssbNum, finalSubjAssignments, finalClIds, 
     file = "Sim_result_iteration.RData")
